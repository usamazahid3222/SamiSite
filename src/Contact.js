...
function Contact() {
  ...
  const formSubmit = (e) => {
    e.preventDefault();
    alert(` My name is ${data.fullname}. My Mobile Number
    is ${data.phone} and email ${data.email}, and here
    is what I want to say : ${data.msg}`);
...
<div className="col-12 ">
    <button className="btn-all" type="submit">Submit form</button>
  </div>
          </form>
        </div>
      </div>
